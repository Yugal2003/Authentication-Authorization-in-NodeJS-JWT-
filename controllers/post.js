...
//Note => we can't  write an 5 condition check point in every single API like above listPosts API so we can create an middleware for this we can pass only middleware whenever its required
